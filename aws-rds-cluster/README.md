...
| Name | Type |
|------|------|
| [aws_backup_plan.multiaz](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/backup_plan) | resource |
...
| <a name="input_cluster_identifier"></a> [cluster\_identifier](#input\_cluster\_identifier) | The name of the RDS instance | `string` | n/a | yes |
...
| <a name="input_create_param_group"></a> [create\_param\_group](#input\_create\_param\_group) | Whether to create this resource or not? | `bool` | `true` | no |
...
| <a name="input_db_cluster_instance_class"></a> [db\_cluster\_instance\_class](#input\_db\_cluster\_instance\_class) | The instance type of the RDS instance | `string` | `"db.m5d.xlarge"` | no |
| <a name="input_db_cluster_parameter_group_name"></a> [db\_cluster\_parameter\_group\_name](#input\_db\_cluster\_parameter\_group\_name) | Name of the DB parameter group to associate | `string` | `null` | no |
...
| <a name="input_param_group_description"></a> [param\_group\_description](#input\_param\_group\_description) | The description of the DB parameter group | `string` | `null` | no |
| <a name="input_param_group_name"></a> [param\_group\_name](#input\_param\_group\_name) | The name of the DB parameter group | `string` | `""` | no |
| <a name="input_param_group_name_prefix"></a> [param\_group\_name\_prefix](#input\_param\_group\_name\_prefix) | Determines whether to use `name` as is or create a unique name beginning with `name` as the specified prefix | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_cluster_parameter_group_arn"></a> [cluster\_parameter\_group\_arn](#output\_cluster\_parameter\_group\_arn) | The ARN of the db parameter group |
| <a name="output_cluster_parameter_group_id"></a> [cluster\_parameter\_group\_id](#output\_cluster\_parameter\_group\_id) | The db parameter group id |
